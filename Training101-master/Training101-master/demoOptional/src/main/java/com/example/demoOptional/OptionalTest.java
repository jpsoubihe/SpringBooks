...
import com.example.demoOptional.User;
...
public class OptionalTest {
    ...
    public static void main(String args[]){
        List<String> lista= new ArrayList<>(Arrays.asList("Teste1","Teste2","Teste3"));
        Optional<List<String>> uo = Optional.ofNullable(lista);
        String s;
        uo.filter(x -> "Teste 4".equals(x)).ifPresent(x -> System.out.println(x + "Está presente na lista"));
...
//        System.out.println("Teste get: "+ uo.get());
